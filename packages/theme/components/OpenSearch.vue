<template>
  <div>
    ...
    <div class="open-search header-top-space">
      ...
      <h4>pour tous</h4>
      <p>
        Un marché mondial pour découvrir n'importe quelle destination. Tapez simplement où vous voulez aller et nous nous occupons du reste.
      </p>
      <div class="open-search-input">
        ...
        <input
          ...
          type="text"
          errorMessage="errer"
          placeholder="Rechercher un emplacement de voyage"
          v-e2e="'home-search-input'"
        />
